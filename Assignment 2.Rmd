...
Below I install requisite packages and save our data. I also edit a few options to expand the size of resulting figures. I chose not to compile all my code at the end so as to not make the document super long. 
